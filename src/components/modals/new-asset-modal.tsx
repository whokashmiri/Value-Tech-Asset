...
const CAMERA_PERMISSION_GRANTED_KEY =
  "assetInspectorProCameraPermissionGrantedV1Modal";
      ...
      <DialogContent className="sm:max-w-2xl max-h-[80vh] flex flex-col">
        ...
        <div className="space-y-4 py-4 flex-grow overflow-y-auto">
          ...
          <div className="space-y-4 mt-4">
            <Label>
              {t("currentPhotoBatch", "Current Photos")} ({photoPreviews.length}
              )
            </Label>
            ...
            <Label>
              {t("currentVideoBatch", "Current Videos")} ({videoPreviews.length}
              )
            </Label>
...
export function NewAssetModal({
  ...
  const [currentStep, setCurrentStep] =
    useState<AssetCreationStep>("photos_capture");
  ...
  const [isManageMediaBatchModalOpen, setIsManageMediaBatchModalOpen] =
    useState(false);
  ...
  const handleMediaUploadFromGallery = useCallback(
    async (event: React.ChangeEvent<HTMLInputElement>) => {
      if (event.target.files) {
        ...
        const processingPromises = newFiles.map(
          (file) =>
        ...
        try {
          ...
          toast({
            title: "Error",
            description: "An error occurred during media processing.",
            variant: "destructive",
          });
        } finally {
          setIsProcessingMedia(false);
  ...
  const removeMediaFromSession = useCallback(
    (indexToRemove: number, type: "photo" | "video") => {
      if (type === "photo") {
        setCapturedPhotosInSession((prev) =>
  ...
  const handleAddSessionMediaToBatch = useCallback(async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to process session media.",
        variant: "destructive",
      });
    } finally {
      setIsProcessingMedia(false);
  ...
  const removeMediaFromPreviews = useCallback(
    (indexToRemove: number, type: "photo" | "video") => {
      if (type === "photo") {
  ...
  const handleBackToNameInput = useCallback(
    () => setCurrentStep("name_input"),
    [],
  );
      ...
      toast({
        ...
        description: !project
          ...
          : t(
              ...
              "User not authenticated. Cannot save asset.",
            ),
        variant: "destructive",
      });
      return;
        ...
        return (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                {t("addPhotosForAssetTitle", "Add Media for:")}{" "}
                <span className="font-medium text-primary">
                  {assetName || t("unnamedAsset", "Unnamed Asset")}
                </span>{" "}
                ({t("forProject", "for")} {project.name})
              </DialogDescription>
            </DialogHeader>
                ...
                <div className="mt-4 space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => setIsManageMediaBatchModalOpen(true)}
                      disabled={isProcessingMedia}
                    >
                  ...
                  <ScrollArea className="h-auto max-h-[120px] pr-2 border rounded-md p-2">
                    <div className="grid grid-cols-10 gap-1.5">
                      {photoPreviews.map((src, index) => (
                        <div
                          key={`main-preview-modal-photo-${index}-${src.substring(0, 30)}`}
                          className="relative group"
                        >
                          <img
                            src={src}
                      ...
                      {videoPreviews.map((src, index) => (
                        <div
                          key={`main-preview-modal-video-${index}-${src.substring(0, 30)}`}
                          className="relative group bg-black rounded-md flex items-center justify-center"
                        >
                          <video
                            src={src}
      ...
      case "name_input":
        return (
          <>
            <DialogHeader>
              <DialogTitle className="text-xl sm:text-2xl font-headline">
                {t("stepNameInputTitleModal", "Step 2: Asset Name")}
              </DialogTitle>
              <DialogDescription>
                {t("provideNameForAsset", "Provide a name for your asset.")}
              </DialogDescription>
            </DialogHeader>
            <div className="flex-grow overflow-y-auto py-4 space-y-4">
              <div className="space-y-2">
                <Label htmlFor="asset-name-modal-comp">
              ...
              <div className="space-y-2">
                <Label htmlFor="serial-number-modal-comp">
      ...
      case "descriptions":
        return (
          <>
            <DialogHeader>
              <DialogTitle className="text-xl sm:text-2xl font-headline">
                {t("stepDescriptionsTitleModal", "Step 3: Descriptions & Save")}
              </DialogTitle>
              <DialogDescription>
                {t("addDetailsForAssetTitle", "Add Details for:")}{" "}
                <span className="font-medium text-primary">{assetName}</span>
              </DialogDescription>
            </DialogHeader>
            <div className="flex-grow overflow-y-auto py-4 space-y-6">
              <audio ref={audioPlayerRef} className="hidden"></audio>
              <div className="space-y-2">
                <Label htmlFor="asset-voice-description-modal">
              ...
              <div className="space-y-2">
                <Label htmlFor="asset-text-description-modal">
                ...
                <Textarea
                  ...
                  rows={
                    assetVoiceDescription.trim() || recordedAudioDataUrl ? 3 : 5
                  }
                  className="resize-y"
                />
              </div>
    ...
    <>
      ...
      >
        <DialogContent
          ...
          hideCloseButton={
            isAudioDescRecording || isRecording || isCustomCameraOpen
          }
        >
          {isCustomCameraOpen ? (
            <CustomCameraDialog
